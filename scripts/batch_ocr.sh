...
# 默认配置（不提供参数时使用）
DEFAULT_PDF_PATH="$PROJECT_DIR/data/高顿/CPA/【26考季】VIPCPA系列-税法（蔡俊峻老师）/01_税法全面精讲01-税法总论/docs/01-课件_税法总论.pdf"
DEFAULT_OUTPUT_DIR="$PROJECT_DIR/data/高顿/CPA/【26考季】VIPCPA系列-税法（蔡俊峻老师）/01_税法全面精讲01-税法总论/docs"
