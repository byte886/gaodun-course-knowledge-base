...
echo "  会计视频数: find data/高顿/CPA/课程库/【VIPCPA专享】名师专业课-会计/原始资源/videos/ -name '*_video.mp4' | wc -l"
echo "  税法视频数: find data/高顿/CPA/课程库/【VIPCPA专享】名师专业课-税法/原始资源/videos/ -name '*_video.mp4' | wc -l"
echo ""
echo "停止所有进程："
