...
4. 会计课（罗翔）           🔄 知识详解生成中 / ⏸️ 做题暂停（正课四来源已齐：视频转写46/46、讲义OCR44、题答176卷、笔记4473条；知识详解连续生成，进度与剩余清单看 `data/_workspace/cpa-accounting-2026/tickets/tickets-index.md`；做题线因风控关闭不追分；网盘09-10已ALL_DONE，新增成品收尾增量再传）
