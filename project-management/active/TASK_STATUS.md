...
> 最后更新：2026-09-11（**会计正课知识详解本地成品全齐**：137 知识点篇 + 30 章 README + 2 全局 Reference = 169 篇、知识点题量合计 1006；笔记 Fan-In 经通用 build_notes_mapping→organize_user_notes 给 128 篇注入「四、学员补充」共 1035 条——alias 补持有待售/PPP 近义名，章级/专题聚合卷正确留 unmatched 不强行挂载，学员名/点赞等身份字段在 mapping 层全剥离；清 paper-82348 模板污染 52 篇、修 82294 多选 BCD 自相矛盾；全库 OKF 校验 E=0。**下一步飞书 resync 全量同步 + 网盘增量**）
>
...
4. 会计课（罗翔）           🔄 本地知识详解成品全齐·待飞书同步 / ⏸️ 做题暂停（正课四来源已齐：视频转写46/46、讲义OCR44、题答176卷、笔记4473条；知识详解本地 **169 篇全齐 = 137 知识点 + 30 章 README + 2 全局 Reference**，128 篇注入「四、学员补充」共 1035 条、全库 OKF 校验 E=0，已清 paper-82348 模板污染（52 篇）与 82294 答案矛盾；**下一步：飞书 resync 全量同步 → 网盘增量**，逐篇进度看 `data/_workspace/cpa-accounting-2026/tickets/tickets-index.md`；做题线因风控关闭不追分）
...
|------|---------|------|-------------------------------|
| **会计** | ep3-accounting-2026 | 🔄 | 四阶段（全面精讲/基础必修/重点强化/考前冲刺）全部完整、607 视频 0 缺（I-014 已澄清早前「缺30」是单老师时代裸 meta 误报并清理），双老师（姚远/陈蓓蓓）；讲义OCR 16/16。实时缺量以 `throttled_ep3_download.sh` 本地完整性统计为准、只认带老师前缀 meta，不看缓存条数 |
| **税法** | ep3-tax-2026 | 🔄 | 全面精讲完整（313 视频）；**2026-09-11 补全基础必修/重点强化/考前冲刺**（新增 95 视频）下载中，双老师（杨志国/高蒙）；讲义OCR 26/26 |
| **战略** | ep3-strategy-2026 | 🔄 | 全面精讲完整（94 视频）；**2026-09-11 补重点强化/考前冲刺**（新增 35 视频）下载中，吴奕主讲（陈岩26考季未挂视频）；讲义OCR 28/28 |
| **经济法** | ep3-econlaw-2026 | 🔄 | 全面精讲完整（266 视频）；**2026-09-11 补重点强化/考前冲刺**（新增 48 视频，本科无基础必修）下载中，双老师（沈甜甜/齐萌）；讲义OCR 36/36（全完） |
