...
| **审计** | ep3-audit-2026 | 🔄视频下载中 / ⏸️做题等通知 | **有视频有讲义**（2026-09-10 晚纠正"纯试卷"误判，见 ISSUES I-010）：四阶段、26考季**单老师王依然**（15251；陈岩15463仅25考季不取），共 314 视频/153 试卷资源/48 讲义；视频/讲义接口不受做题风控连带，已纳入 throttled 下载。**做题线**触发账号风控 10462221，剩余队列见该课 `papers_audit.json`，**AI 不申请/不申诉/不反复试探，等用户通知**；解除后用 fetch_ep3_paper_readonly 只读回补（见 ISSUES I-009） |
| **财管** | ep3-finance-2026 | 🔄视频下载中 / ⏸️做题等通知 | **有视频有讲义**（同 I-010）：四阶段、26考季**单老师李晶**（11134；周越26考季未挂），共 389 视频/174 试卷资源/28 讲义，已纳入下载。做题线同审计、等用户通知；已做卷题面/答案/解析待解除后只读回补 |
