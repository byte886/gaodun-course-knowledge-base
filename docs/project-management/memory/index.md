...
* [四地存储分工与仓库版图](concepts/architecture-storage-layout.md) - Git/本地 data 实体目录/网盘/飞书各放什么、data 实体与 gitignore 边界、什么才入库
...
* [名师课网盘 hevc 整科门控覆盖同步与终态核验](concepts/workflow-netdisk-hevc-sync.md) - 整科全 hevc 才传、清视频 done（保 notes）+rtype=3 覆盖 h264、双机各并发1限速1000k、verify_netdisk_final 大小核验为准不信 done
