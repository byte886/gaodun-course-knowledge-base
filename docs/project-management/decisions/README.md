...
| [ADR-022](./ADR-022-名师课双机并行H265重压与整科门控网盘覆盖.md) | 六科 h264 双机科目零重叠并行重压 hevc（本机审计/战略/经济法/税法、目标机会计/财管，rsync 同构迁移不走 git，--jobs 按忙闲调档）；本机 launchd 总管、目标机 caffeinate 看门常驻保活；网盘"整科全 hevc 才传 + 清视频 done 保 notes + rtype=3 覆盖早期 h264"，双机各并发 1 限速 1000k；终态以 verify_netdisk_final 大小核验为准不信 done | 已采纳 | 2026-09-16 |
